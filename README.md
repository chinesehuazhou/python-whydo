...
如果你有其它话题建议，欢迎[提交 Issue](https://github.com/chinesehuazhou/python-whydo/issues/new)。目前的文章主要是中文，欢迎你来翻译成其它语言的版本，同时，欢迎将翻译后的文件提交 pull request 到本仓库。
...
- [Python 疑难问题：[] 与 list() 哪个快？为什么快？快多少呢？](https://github.com/chinesehuazhou/python-whydo/blob/master/zh_CN/17-why-is-[]-faster-than-list().md)
...
- [Python文档](https://docs.python.org/3/index.html)：关于语言本身的很多问题，都能在文档中找到解答 
